		...
		<div class="header_bottom_left">
			...
			<div class="section group">
			   ...
			   <?php
				...
				if($getLastestOP){
					while($result_op = $getLastestOP->fetch_assoc()){
				 ?>		
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="details.php"> <img src="admin/uploads/<?php echo $result_op['image'] ?>" alt="" /></a>
					</div>
				    <div class="text list_2_of_1">
						<h2>Huawei</h2>
						<p><?php echo $fm->textShorten($result_op['productName'],35) ?></p>
						<div class="button"><span><a href="details.php?proid=<?php echo $result_op['productId'] ?>">Thêm vào giỏ</a></span></div>
				   </div>
			   </div>
			   <?php
				}}
